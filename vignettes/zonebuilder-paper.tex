...
% Insert your manuscipts authors, affiliations, and addresses
  ...
  \author{Dustin Carlino}\affil{Alan Turing Institute, London, UK}
...
{\centering \includegraphics[width=0.32\linewidth]{zonebuilder-paper_files/figure-latex/options-1} \includegraphics[width=0.32\linewidth]{zonebuilder-paper_files/figure-latex/options-2} \includegraphics[width=0.32\linewidth]{zonebuilder-paper_files/figure-latex/options-3} 
...
{\centering \includegraphics[width=0.7\linewidth]{zonebuilder-paper_files/figure-latex/london-1} 
...
{\centering \includegraphics[width=0.85\linewidth]{zonebuilder-paper_files/figure-latex/intercity-1} \includegraphics[width=0.85\linewidth]{zonebuilder-paper_files/figure-latex/intercity-2} 
