...
of how people make mental maps and navigate the city [^1].
    ...
    **Response:** We agree that this would be a useful next step for the research.
    ...
    While that study is beyond the scope of this paper, which focusses on the design of the proposed zoning system and discussion of the importance of alternative zoning systems for urban analysis, we would like to take the ideas forward in future work and have rewritten parts of the discussion accordingly.
