...
I suspect that the method will be useful, but in fewer cases than originally purported. One of the strongest features seems to be the earmarking system with the B3, F12, etc. which, as stated, is helpful to let the user know automatically how far from the city they are and what direction. This is a nice contribution. In addition, the arbitrary starting point of a grid is solved a bit by this method. Comparing across cities seems like a great use for this method.

The presentation is generally good and clear to follow. Again, the limitations section should be more forthright, as this new method does have some significant drawbacks. I have a few recommendations:

P 2: “…to represent lines of equal height, and…population density.” I found it odd to bring up contour lines when the authors are specifically talking about continuous space. I realize that these lines demarcate continuous space, but they are rarely used to actually do this. Please remove. At the same time, it is very undervalued that you cannot do table joins with the clockboard method, as you could when aggregating to existing units. (More for the limitations.)

P 3: OSM is also odd to bring up as ‘emerging datasets’---it doesn’t have any thematic data, which I think is a big selling point of your method. At least the case studies on pollution and traffic suggest so. Please substitute it.

P 3: Can you elaborate on reference [21], it sounds important.

P 3: Paragraph starting with “Pre-existing zoning systems” does not seem to belong here. It seems to need to come earlier.

P 4: “Modelling urban cities…” bullet point is quite vague and I’m not sure what it adds.

P 6: “The trueism is often reflected….” Census zones are way more popular than TAZes, I found this odd to mention TAZes instead.

Table 1: Please make it clearer that N. zones is cumulative.

 —one part of ‘o clock may need to be lowercased.

-P 8: does “Tokyo” call anything when it’s used as a variable in ClockBoard_Tokyo? Please clarify.

-Fig 8: Could you please provide a scale bar?
...
One small point in this section: The authors did not explicitly state
...
The authors state that "A number of approaches have tackled the question
...
While I think this may be beyond the scope of this paper, I think a true
...
One aspect of the design of the framework that was unclear to me is the
...
A minor point regarding comparison across different cities: I don't
...
The problem statement and the significance of this work is not quite
...
Fundamentally, the overall objective, target audience, and use cases are
...
There is sufficient originality in this work to justify publication of
...
A major issue with this paper is its structure in the introduction which
...
Another major source of confusion is the use of the term 'zones' or
...
With some reframing and reworking of the structure, I think this paper
