We are very happy to resubmit the paper with minor updates requested, please find the updated version in a [zip here](https://github.com/zonebuilders/zonebuilder/releases/download/v0.0.2.9000/clockboard-paper-resubmission-final-corrections.zip) and the comments on the very useful final comments below.
...
Find our corrected version, with all source files for typesetting, here: https://github.com/zonebuilders/zonebuilder/releases/download/v0.0.2.9000/clockboard-paper-resubmission-final-corrections.zip