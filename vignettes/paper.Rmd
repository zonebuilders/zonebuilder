...
The ClockBoard zoning system presented in this paper was designed to overcome some well-known and long-standing issues associated with commonly available administrative zoning systems, which are still often used as the default unit of analysis for urban analysis in many parts of the world.



 from the perspective of urban analysis of monocentric cities.
...
The ClockBoard zoning system provides a shared geographic frame of reference for any city --- or indeed any geographic system with a clear central point --- worldwide, is easy to communicate (with zone labels such as A, B01 and C12), and clearly demarcates the location of phenomena in terms of angle and distance from the centre.
