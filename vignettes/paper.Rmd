...
Although those zoning systems are usually in line with the hierarchical organizational structure of governmental organizations, and therefore may work well for policy making, there are a couple of downsides to using such zoning systems.
First, since a city and its politics change over time, the administrative regions often change accordingly.
...
In order to address these shortcomings of zoning systems based on administrative regions, our aim in this paper is to build a zoning system from scratch, i.e. to divide a *continuous* geographic space into zones **starting from a blank slate**, without reference to pre-existing areal units.
...
The approach presented in this paper aims to minimize data requirements, generate consistent zones comparable between widely varying urban systems, and provide geographically contiguous areal units.
