...
abstract: |
  ...
  are either non-existent, not publicly available, or are too coarse.
  To tackle these we set out to develop a
  flexible, open and scalable solution.
  The result is the ClockBoard zoning system, which
  consists of 12 segments divided by concentric rings of
  increasing radius.
  ...
  outlines the design and potential uses of the ClockBoard
  zoning system in the historical context, and
  and discusses future avenues for research and
  development of new zoning systems.
...
```{r popdens, fig.cap="ClockBoard for 30 world cites. The blue raster grid cells represent open access population estimates from the WorldPop project; the red lines are administrative borders (where they could be found).", out.width="70%"}
