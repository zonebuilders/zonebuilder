...
The ClockBoard zoning system tackles the issues outlined above based on the following criteria.
From an urban analysis perspective, zoning systems should:
