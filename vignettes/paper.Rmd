...
# For paper
# Comment the above and uncomment below for LaTeX version
# title: "Habits"
# output:
#   bookdown::pdf_book:
...
The problem that we tackle in this paper is different, however: it is
...
documented since at least the 1960s, with a prominent paper on
...
-   Reference system of everyday live. The zone name contains
...
[@ross_dicuil_2019], as outlined in Table \@ref(tab:t1).
...
knitr::kable(t1, format = "latex", booktabs = TRUE, caption = "Key attributes of first 9 rings used in the ClockBoard zoning system.")
```
