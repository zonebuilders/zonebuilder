...
```{r options, fig.cap="Illustration of ideas explored in the lead-up to the development of the ClockBoard zoning system."}
# z1 = zb_zone(x = london_c(), n_segments = 1)
# m1 = qtm(z1, title = "(A) Concentric Annuli")
zb_plot(zb_zone(london_c(), n_segments = 1), title = "(A) Concentric Annuli")
zb_plot(zb_segment(london_c(), n_segments = 8), title = "(B) Segments")
zb_plot(zb_zone_equal_area(london_c(), n_circles = 5, n_segments = 8), title = "(A) Concentric Annuli")
```
