...
While the utility of the zoning system is likely to limited in many settings by these limitations, we believe that there are settings in which ClockBoard could provide substantial benefits, as demonstrated in three example applications.
...
We hope that the concept of the ClockBoard zoning system presented in this paper, and the ease with which open access data representing 'ClockBoards' for different cities, will encourage more quantitative urban analytical research comparing different cities.
