...
After a period of informal testing and feedback from people who work with zones, we focussed on the 'ClockBoard' zoning system presented in this paper.
The zoning system is based on:
...
The radius of each annuli in the zoning system can be incremented by a fixed amount, as shown in Figure \@ref(fig:options).
