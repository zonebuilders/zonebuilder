...
output:
  bookdown::pdf_book:
    # base_format: rticles::josis
    keep_tex: true
keywords: "zoning, areal data, zoning systems, modifiable area unit problem"
bibliography: references.bib
csl: josis.csl
author:
   - Robin Lovelace, Institute for Transport Studies University of Leeds, UK
   - Martijn Tennekes, Centraal Bureau voor de Statistiek, The Netherlands
   - Dustin Carlino, Independent Software Engineer, Lead Developer of A/B Street, USA
abstract: |
