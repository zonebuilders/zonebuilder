...
It aims to balance the need for comparatively small zones (compared with city quadrants) and simplicity.
The balanced is tipped towards simplicity, with 'readability' perhaps being the most important criteria in its design.
ClockBoards enable communication about locations within city with only 3 characters and a simple mental model based on the widely understood concept of a clock.
