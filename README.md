...
#> Skipping install of 'zonebuilder' from a github remote, the SHA1 (17e7530b) has not changed since last install.
...
#> 2          2          1   B01 POLYGON ((530325.3 182602.3...
#> 3          2         10   B10 POLYGON ((528203.9 178928, ...
#> 4          2         11   B11 POLYGON ((528203.9 180481, ...
#> 5          2         12   B12 POLYGON ((528980.4 181825.8...
#> 6          2          2   B02 MULTIPOLYGON (((531808.8 18...
#> 7          2          3   B03 MULTIPOLYGON (((532067.6 17...
#> 8          2          4   B04 MULTIPOLYGON (((534101.7 17...
#> 9          2          5   B05 POLYGON ((533999.5 178928, ...
#> 10         2          6   B06 POLYGON ((533223 177583.2, ...
qtm(z)
```
...
#>     distance = 1, distance_growth = 1, starting_angle = -15, 
#>     segment_center = FALSE, intersection = TRUE) 
#> NULL
```
