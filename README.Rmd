...
Attaching the package provides the example datasets `london_area` and `london_cent`, the geographic boundary and the centre of London:
...
zb_plot(zb_zone(london_cent, n_circles = 4, n_segments = 4), title = "Zone with 4 circles and 4 segments")
```
